 ...
 */
    ...
    function makeHappy(words){
        ...
        let outputArr = words.map ((word) => {return 'Happy '+ word});
        return outputArr;
 ...
 */
    ...
    let newArr = objects.map((properties) => {return properties.streetNumber + " " + properties.streetName+ " " + properties.streetType+ " " + properties.city + " " +properties.state+ " " + properties.zip});
    return newArr;
    }
...
let largest = value [0];
value.forEach( (x) => {if (x > largest) largest = x;});
return largest;
