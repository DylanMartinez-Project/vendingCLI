...
public class Exercises {
    ...
    public int arrayCount9(int[] nums) {
        ...
        for (int i = 0; i < nums.length; i++) {  // loops through array 1 by 1

            if (nums[i] == 9) {                // if ARRAY VALUE OF I 	 == 9
...
//            return newOne;
    ...
    public int[] makeLast(int[] nums) {
        ...
        int[] newOne = new int[(nums.length)*2];
        newOne[newOne.length-1]= nums[nums.length-1] ;
        return newOne;
    }
